...
namespace VoxelEngine {
    ...
    public:
        ...
        entt::sink<entt::sigh<void(uint32_t, uint32_t)>>& onResized() { return m_onResized; }
        entt::sink<entt::sigh<void(uint32_t, uint32_t)>>& onFramebufferResized() { return m_onFramebufferResized; }
    ...
    private:
        ...
        entt::sink<entt::sigh<void(uint32_t, uint32_t)>> m_onResized;

        entt::sigh<void(uint32_t, uint32_t)> m_onFramebufferResizedSignal;
        entt::sink<entt::sigh<void(uint32_t, uint32_t)>> m_onFramebufferResized;
