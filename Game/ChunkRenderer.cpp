...
void ChunkRenderer::createPipeline() {
    auto vertpath = "../assets/spirv/shader.vert.spv";
    auto fragpath = "../assets/spirv/shader.frag.spv";
    std::vector<char> vertShaderCode = VoxelEngine::readFile(vertpath);
    std::vector<char> fragShaderCode = VoxelEngine::readFile(fragpath);
