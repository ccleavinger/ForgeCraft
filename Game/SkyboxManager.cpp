...
static const std::vector<std::string> textures = {
    "../assets/resources/sky_right.png",
    "../assets/resources/sky_left.png",
    "../assets/resources/sky_up.png",
    "../assets/resources/sky_down.png",
    "../assets/resources/sky_front.png",
    "../assets/resources/sky_back.png",
};
...
void SkyboxManager::createPipeline(vk::RenderPass& renderPass) {
    std::vector<char> vertShaderCode = VoxelEngine::readFile("../assets/spirv/skybox.vert.spv");
    std::vector<char> fragShaderCode = VoxelEngine::readFile("../assets/spirv/skybox.frag.spv");
