...
const std::string textureName = "../assets/resources/selection.png";
...
void SelectionBox::createPipeline(vk::RenderPass& renderPass) {
    std::vector<char> vertShaderCode = VoxelEngine::readFile("../assets/spirv/selection.vert.spv");
    std::vector<char> fragShaderCode = VoxelEngine::readFile("../assets/spirv/selection.frag.spv");
